...
export const publicsStoreName = 'publics' as const
export const organismesStoreName = 'organismes' as const
export const categoriesStoreName = 'categories' as const
export const servicesStoreName = 'services' as const
export const revisionStoreName = 'revision' as const
